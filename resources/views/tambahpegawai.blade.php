...
<div class="container">
    <div class="row align-items-center">
        <div class="card-body">
            ...
            <h4>Filter Data Pencarian</h4>
            <form action="/filterPegawai" method="POST">
                @csrf
                <table width="100%" cellpadding='3px'>
                    <tr>
                        <td width="50%"><input type="hidden" name="akses_id" id="akses_id" value="2" /></td>
                    </tr>
                    <tr>
            ...
            <table width="100%" class="table table-bordered" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="18%" style="padding:5px;">{{$pegawai['nama_lengkap']}}</td>
                        <td width="17%" style="padding:5px;">{{$pegawai['nip']}}</td>
                        <td width="15%" style="padding:5px;">{{$pegawai['jabatan']}}</td>
                        <td width="20%">{{$pegawai['skpd']}}</td>
                        <td width="5%"><a href='{{route("pilihPegawai",[$pegawai["id_pegawai"]])}}' class="btn btn-info" title="pilih ini"><box-icon name="log-in-circle"><box-icon></a></td>
                    </tr>
                    @php $no++; @endphp
                    @endforeach
                    @endif
