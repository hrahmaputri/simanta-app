        ...
        <div class="card-body">
            ...
            <form action="/filterPegawai" method="POST">
                ...
                <table width="100%" cellpadding='3px'>
                    <tr>
                        <td width="50%"><input type="hidden" name="akses_id" id="akses_id" value="1" /></td>
                    </tr>
                    <tr>
            ...
            <table width="100%" class="table table-bordered" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="5%"><a href='{{route("satuPegawai",[$pegawai["id_pegawai"]])}}' class="btn btn-info" title="pilih ini"><box-icon name="exit"><box-icon></a></td>
                    </tr>
                    @php $no++; @endphp
                    @endforeach
                    @endif
